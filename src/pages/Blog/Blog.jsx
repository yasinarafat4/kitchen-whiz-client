  ...
  return (
    <div className="m-4">
      ...
      <div className="ms-4">
        ...
        <p>
          # Uncontrolled components are those in which the form data is handled
          by the DOM itself, rather than being controlled by React. In this
          case, the form fields are not bound to any state, and the data is
          handled by the DOM.{" "}
        </p>

        <p>
          # Controlled components are those in which the form data is handled by
          React state. In this case, the value of each form field is bound to a
          corresponding state value, and any changes made to the form data are
          handled by updating the state.
        </p>
      </div>
      ...
      <div className="ms-4">
        <p>
          PropTypes is a library that allows developers to define the data types
          of each prop that are passed to a React component.
        </p>
      ...
      <div className="ms-4">
        <p>
          ...
          building web applications with JavaScript. The key difference between
          nodejs and express js is:
        </p>
      ...
      <div className="ms-4">
        ...
        <p>
          ...
          more modular and reusable code, making it easier to maintain and scale
          React applications.
        </p>

        <p>
          Developers may create custom hooks for a variety of reasons, including
          reducing code duplication, improving code organization, and improving
